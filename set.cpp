...
void Confirmorder(){
    ...
    do{
        ...
        cout << ": Enter Money : "<< setw(23) << " ";
        cin >> money;
    } while (money < Totalsumss);
        balanc = money - Totalsumss;
        cout << right << ": give the change :" << setw(24)  << balanc << " Baht" << endl << endl;
...
void ViewRePortDay(){
    ...
    string day[7] = {"Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"};
    string month[12] = {"January","February","March","April","May","June","July","August","September","October","November","December"};
    int OsQl[1000] = {},OsPid[1000][1000] = {},Osflour[1000][1000] = {}, OsQ[1000][1000] = {};
    string Ossize[1000][1000] = {},OsId[1000] = {};
    string stridss;
    ifstream reads;
    reads.open("C:/ProjectPizza/product.txt");
    int x = 0,k = 0;
